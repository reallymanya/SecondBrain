    ...
    return (<div className="w-72 h-screen bg-[#050505] border-r border-white/5 flex flex-col p-6 fixed left-0 top-0 z-20">
            ...
            <div className="space-y-2 flex-1">
                ...
                : "text-slate-400 hover:text-white hover:bg-white/5"}`}>
                        ...
                        {activeTab === item.id && (<span className="ml-auto w-1.5 h-1.5 rounded-full bg-purple-400 shadow-[0_0_8px_rgba(168,85,247,0.5)]"></span>)}
                    </button>))}
            </div>
            ...
            <div className="pt-6 border-t border-white/5 space-y-4">
                <div className="flex gap-2">
                    ...
                    <button onClick={onShare} className="h-10 px-4 rounded-xl bg-purple-500/10 border border-purple-500/20 text-purple-400 hover:bg-purple-500/20 transition-colors" title="Share Brain">
                        <Share2 className="w-4 h-4"/>
                    </button>
                </div>

                <button onClick={handleLogout} className="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-slate-500 hover:text-red-400 hover:bg-red-500/5 transition-colors">
