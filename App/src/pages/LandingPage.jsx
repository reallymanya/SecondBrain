...
const LandingPage = () => {
    ...
    return (<div className="min-h-screen w-full bg-[#030014] overflow-x-hidden font-sans selection:bg-purple-500/30 text-white relative">
                ...
                <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="relative flex justify-center items-center h-[400px]">
                        ...
                        <div className="relative w-full max-w-md aspect-square group cursor-pointer">
                            ...
                            {/* Floating Icons */}
                            <motion.div animate={{ y: [0, -15, 0] }} transition={{ duration: 4, repeat: Infinity, ease: "easeInOut" }} className="absolute top-10 right-10 p-3 bg-red-600/20 backdrop-blur-md rounded-xl border border-red-500/30 flex items-center gap-3">
                                <Youtube className="w-6 h-6 text-red-500"/>
                                <span className="text-sm font-bold">Saved Videos</span>
                            </motion.div>

                            <motion.div animate={{ y: [0, 15, 0] }} transition={{ duration: 5, repeat: Infinity, ease: "easeInOut", delay: 0.5 }} className="absolute bottom-20 left-0 p-3 bg-blue-500/20 backdrop-blur-md rounded-xl border border-blue-500/30 flex items-center gap-3">
        ...
        ].map((step, i) => (<div key={i} className="p-8 rounded-2xl bg-white/5 border border-white/5 relative overflow-hidden group">
